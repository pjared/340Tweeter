...
public class FollowingServiceProxyTest {
    ...
    private FollowingServiceInterfaceProxy followingServiceProxySpy;
    ...
    public void setup() throws IOException, TweeterRemoteException {
        ...
        Mockito.when(mockServerFacade.getFollowees(validRequest, FollowingServiceInterfaceProxy.URL_PATH)).thenReturn(successResponse);

        failureResponse = new FollowingResponse("An exception occurred");
        Mockito.when(mockServerFacade.getFollowees(invalidRequest, FollowingServiceInterfaceProxy.URL_PATH)).thenReturn(failureResponse);

        // Create a FollowingService instance and wrap it with a spy that will use the mock service
        followingServiceProxySpy = Mockito.spy(new FollowingServiceInterfaceProxy());
